 ...
 */
export async function decryptONSValue(
	encryptedMessageHex: string,
	ons: string,
): Promise<Uint8Array | null> {
	const encryptedMessage = hexToUint8Array(encryptedMessageHex);
	const legacyFormat = encryptedMessage.length === SESSION_PUBLIC_KEY_BINARY_LENGTH + 16;
	try {
 ...
 */
export function decryptXChachaWithKey(
	message: Uint8Array,
	nonce: Uint8Array,
	key: Uint8Array,
): Uint8Array {
...
export function decryptSecretboxWithKey(message: Uint8Array, key: Uint8Array): Uint8Array {
	const xsalsa = xsalsa20poly1305(key, new Uint8Array(24));
...
export function splitEncryptedMessage(encryptedMessage: Uint8Array): [Uint8Array, Uint8Array] {
	const messageLength = encryptedMessage.length - 24;
